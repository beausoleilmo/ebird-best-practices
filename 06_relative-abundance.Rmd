...
Let's start by loading the necessary packages and data. If you haven't already done so, you may want to [download the data package](https://github.com/mstrimas/ebird-best-practices/raw/master/data/data.zip) and unzip it to your working directory. As in previous chapters, the Checklist Calibration Index (CCI) is an optional covariate in these models. If you've [downloaded](https://ebird.org/data/download) these data, put the CCI text file in the `data/` subdirectory of your project. If you haven't downloaded these data, you can still proceed with running code, but the resulting models will likely have lower predictive performance and your maps may have some differences to those shown here.
