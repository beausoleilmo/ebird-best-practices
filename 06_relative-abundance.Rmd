...
### Validation {#abundance-model-val}
...
If these relationships seem too wiggly to be biologically realistic, you should reduce the degrees of freedom for the smooth until a biologically feasible relationship is achieved. In this case, the relationships appear to be reasonable. Next we'll proceed with a formal cross-validation of the three models. Recall from Section \@ref(encounter-rf-val) that this involves making predictions for the test dataset, which wasn't used to fit the models, then assessing how well these predictions relate to the actual observed counts.
...
It appears based on this metric, that the zero-inflated Poisson model is performing worst in terms of underestimation. Let's examine some of the cross-validation metrics: deviance explained, mean-squared error (MSE), and Spearman's rank correlation.

```{r encounter-rf-val-metrics}
# deviance explained
...
```{r encounter-rf-val-metrics-print, echo = FALSE}
