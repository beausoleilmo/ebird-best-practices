...
In the following code, we download and prepare a variety of GIS layers, then save them all within a [GeoPackage](https://www.geopackage.org/) in the `data/` subdirectory of the project. This will allow us to load these data in later chapters as they're needed.
