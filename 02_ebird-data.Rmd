...
Due to the very small sample sizes of records with 3 or more observers, reducing the number of checklists from `r scales::comma(nrow(ebird))` to `r scales::comma(nrow(filter(ebird, number_observers <= 5)))` records will reduce the need to model the number of observers as a covariate for detection, and not significantly reduce sample size.